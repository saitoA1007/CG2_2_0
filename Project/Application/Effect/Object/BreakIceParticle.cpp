...
void BreakIceParticle::Initialize(const uint32_t& texture, const Vector3& emitPos) {
...
void BreakIceParticle::ApplyDebugParam(IceRockMaterial::MaterialData& iceMaterial) {
