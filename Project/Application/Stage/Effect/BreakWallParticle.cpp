...
void BreakWallParticle::Initialize(const uint32_t& texture, const Vector3& emitPos) {
	// 画像を取得
	particleGH_ = texture;
...
BreakWallParticle::ParticleData BreakWallParticle::MakeNewParticle() {
...
void BreakWallParticle::RegisterBebugParam() {
	int index = 0;
...
void BreakWallParticle::ApplyDebugParam() {
