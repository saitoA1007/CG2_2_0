#include"EnterWingsParticle.h"
#include"FPSCounter.h"
#include"RandomGenerator.h"
#include"GameParamEditor.h"
using namespace GameEngine;

void EnterWingsParticle::Initialize(const uint32_t& texture) {
	// 画像を取得
	particleGH_ = texture;
...
void EnterWingsParticle::Update() {
#ifdef _DEBUG
	ApplyDebugParam();
#endif
...
EnterWingsParticle::ParticleData EnterWingsParticle::MakeNewParticle() {
...
void EnterWingsParticle::Create() {
	// 経過時間を加算
...
void EnterWingsParticle::RegisterBebugParam() {
	int index = 0;
...
void EnterWingsParticle::ApplyDebugParam() {
	// 発生数
