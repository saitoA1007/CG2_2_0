...
void VignettingPSO::Initialize(ID3D12Device* device, DXC* dxc) {

    // 初期化を開始するログ
    LogManager::GetInstance().Log("VignettingPSO Class start Initialize");
    ...
    // 初期化を終了するログ
    LogManager::GetInstance().Log("VignettingPSO Class End Initialize\n");
