...
void GameScene::Initialize(GameEngine::TextureManager* textureManager, GameEngine::DirectXCommon* dxCommon) {
	...
	lineMesh.Initialize({ 0.0f,0.0f,0.0f }, { 10.0f,2.0f,0.0f }, { 1.0f,0.0f,0.0f,1.0f });
}
...
void GameScene::Draw() {
	...
	case Scene::kTriangle:
		...
		//primitiveRenderer_->DrawLine3d(&lineMesh, camera_->GetVPMatrix());
		primitiveRenderer_->DrawLine3d(&lineMesh, debugCamera_->GetVPMatrix());
